...
var sources = []*ast.Source{
	{Name: "graph/schema.graphqls", Input: `# articleサービスとやり取りするArticleの形定義
type Article {
  id: Int!
  author: String!
  title: String!
...
func (ec *executionContext) field_Mutation_createArticle_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNCreateInput2go_grpcᚋgraphᚋmodelᚐCreateInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) field_Mutation_updateArticle_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
		arg0, err = ec.unmarshalNUpdateInput2go_grpcᚋgraphᚋmodelᚐUpdateInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createArticle(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNArticle2ᚖgo_grpcᚋgraphᚋmodelᚐArticle(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_articles(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Article)
	fc.Result = res
	return ec.marshalNArticle2ᚕᚖgo_grpcᚋgraphᚋmodelᚐArticleᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNArticle2go_grpcᚋgraphᚋmodelᚐArticle(ctx context.Context, sel ast.SelectionSet, v model.Article) graphql.Marshaler {
	return ec._Article(ctx, sel, &v)
}

func (ec *executionContext) marshalNArticle2ᚕᚖgo_grpcᚋgraphᚋmodelᚐArticleᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Article) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNArticle2ᚖgo_grpcᚋgraphᚋmodelᚐArticle(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNArticle2ᚖgo_grpcᚋgraphᚋmodelᚐArticle(ctx context.Context, sel ast.SelectionSet, v *model.Article) graphql.Marshaler {
	if v == nil {
...
func (ec *executionContext) unmarshalNCreateInput2go_grpcᚋgraphᚋmodelᚐCreateInput(ctx context.Context, v interface{}) (model.CreateInput, error) {
...
func (ec *executionContext) unmarshalNUpdateInput2go_grpcᚋgraphᚋmodelᚐUpdateInput(ctx context.Context, v interface{}) (model.UpdateInput, error) {
